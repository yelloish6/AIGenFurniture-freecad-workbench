...
class CorpCuPicioare(Cabinet):
    def __init__(self, label, height, width, depth, rules, h_skirt, has_skirting_board = False):
        drill_depth_offset = 120 # distance from the other edge of the cabinet to where the screw is assembled
        """
        Simple cabinet with skirting board:
        |-------|
        |       |
        |       |
        |_______|
        ...
        # lat1.drill("front", drill_depth_offset, h_skirt + jos.thick / 2)
        # lat2.drill("front", drill_depth_offset, h_skirt + jos.thick / 2)
        ...
        ASSEMBLIES["euro_screw"](lat1, jos)
        ASSEMBLIES["euro_screw"](lat2, jos)
        ASSEMBLIES["euro_screw"](lat1, sus)
        ASSEMBLIES["euro_screw"](lat2, sus)
        ASSEMBLIES["euro_screw"](lat1, skirting_board)
        ASSEMBLIES["euro_screw"](lat2, skirting_board)
        ASSEMBLIES["euro_screw"](jos, skirting_board)
